...
function create_filter_element(data) {
  ...
  */
  ...
  let new_dom_ele_li = document.createElement("li");
  new_dom_ele_li.classList.add(data.class);
  new_dom_ele_li.classList.remove("selected");
  new_dom_ele_li.textContent = data.textContent;
  data.parent.appendChild(new_dom_ele_li);
  new_dom_ele_li.addEventListener("click", click_filter_element)
  return new_dom_ele_li;
}
